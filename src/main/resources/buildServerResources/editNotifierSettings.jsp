      ...
      <div class="tn-form-grid">
        ...
        <div class="tn-form-group tn-form-group-full">
          ...
          <div class="tn-triggers-grid">
            ...
            <label class="tn-trigger">
              <input type="checkbox" id="onFirstFailure" class="tn-trigger-checkbox">
              <div class="tn-trigger-card">
                <svg class="tn-trigger-icon tn-trigger-failure" viewBox="0 0 20 20" fill="currentColor">
                  <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                </svg>
                <span>On First Failure</span>
              </div>
            </label>

            <label class="tn-trigger">
              <input type="checkbox" id="onBuildFixed" class="tn-trigger-checkbox">
              <div class="tn-trigger-card">
                <svg class="tn-trigger-icon tn-trigger-success" viewBox="0 0 20 20" fill="currentColor">
...
(function() {
  ...
  async function addWebhook() {
    ...
    const triggers = ['onStart', 'onSuccess', 'onFailure', 'onStall', 'onCancel', 'onFirstFailure', 'onBuildFixed', 'buildLongerThanAverage', 'useBuildLongerThan'];
    ...
    const params = new URLSearchParams({
      ...
      onFirstFailure: document.getElementById('onFirstFailure').checked,
      onBuildFixed: document.getElementById('onBuildFixed').checked,
  ...
  function resetForm() {
    ...
    document.getElementById('onCancel').checked = false;
    document.getElementById('onFirstFailure').checked = false;
    document.getElementById('onBuildFixed').checked = false;
