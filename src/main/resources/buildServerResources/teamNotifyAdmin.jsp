...
function showToast(message, type) {
  ...
  // Render the icon as trusted markup, but the (potentially server- or error-derived) message
  // as text only, so it can never inject HTML/script into the page.
  var iconSpan = document.createElement('span');
  iconSpan.className = 'tn-toast-icon';
